export default function MotoTerminalCard({ amount, setAmount, onSubmitCollect, onCancel }) {
  return (
    <div className="stripe-card">
      <div className="stripe-card-header">
        <h3 className="stripe-card-title">MOTO 決済</h3>
        <p className="stripe-card-subtitle">Process mail/telephone order payment</p>
      </div>
      <form onSubmit={onSubmitCollect} className="stripe-flex stripe-flex-col stripe-gap-4">
        <div>
          ...
          <div className="stripe-text-sm" style={{ marginTop: '4px' }}>
            Terminal にて MOTO 入力でこのお客様に請求されます
          </div>
        </div>
